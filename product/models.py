...
class Product(models.Model):
    ...
    discount_percentage = models.DecimalField(max_digits=3, decimal_places=0, null=True, blank=True)
    ...
    current_bid_amount = models.DecimalField(max_digits=10, decimal_places=2)
    active_bidders = models.IntegerField()
